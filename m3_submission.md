...
<tr><td> <em>Generated: </em> 10/2/2023 5:18:22 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT114-001-F23/it114-number-guesser/grade/mh82" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmh82%2F2023-10-02T20.44.04image.png.webp?alt=media&token=5495c7c2-1f61-43c9-8184-69a551c6f8de"/></td></tr>
<tr><td> <em>Caption:</em> <p>Screenshot of the implemenation of the code working. Included maximum strikes after each<br>level and hints of higher or lower after each guess<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmh82%2F2023-10-02T21.00.22image.png.webp?alt=media&token=fd9aa517-b04b-40ce-b5b4-63cd4236adb4"/></td></tr>
<tr><td> <em>Caption:</em> <p>Code of hint of guess higher or lower was implemented<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain the logic behind your implementation</td></tr>
<tr><td> <em>Response:</em> <p>Whenever a number was input, if the number was not guessed correctly,&nbsp; a<br>hint would appear in the output of either higher or lower. Using the<br>else if statement, if the guess was higher than the number, the hint<br>would be &quot;select lower number&quot;. If the guess was lower than the lower,<br>the hint would be &quot;select higher number&quot;.&nbsp;<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td> <em>Sub-Task 1: </em> Two Screenshots: Add a screenshot demonstrating the feature during runtime; Add a screenshot (or so) of the snippets of code that implement the feature</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmh82%2F2023-10-02T20.59.45image.png.webp?alt=media&token=c8f254d0-6d55-402b-b554-7f7413d3251b"/></td></tr>
<tr><td> <em>Caption:</em> <p>Code implemented here was the maximum number of strikes allowed for each level.<br><br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmh82%2F2023-10-02T21.01.49image.png.webp?alt=media&token=0e05f689-05ab-4d95-98d5-cde0316d97b4"/></td></tr>
<tr><td> <em>Caption:</em> <p>Shows the number of strikes implemented in the output of the program after<br>a level is cleared<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain the logic behind your implementation</td></tr>
<tr><td> <em>Response:</em> <p>After each guess, a strike is counted for every time a guess is<br>incorrect. For each level, there is a maximum number of strikes depending on<br>the difficulty of the level. Use the if else statement, if there are<br>more than 5 strikes on one level, the difficulty level will decrease.&nbsp;<br></p><br></td></tr>
</table></td></tr>
